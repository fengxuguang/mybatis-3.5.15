...
public class ResolverUtil<T> {
	...
	/**
	 * 通过将 package 包名中的 . 替换为 /, 使用目录层级方式显示 Converts a Java package name to a path that can be looked up with a call to
	...
	/**
	 * 当且仅当提供的测试匹配时, 将所提供的完全限定类名指定的类添加到已解析类集中。 Add the class designated by the fully qualified class name provided to the
